...
run_hf(){
    ...
    do
        CUDA_VISIBLE_DEVICES=0 python begin.py \
            ...
            --output_path /scratch/popeq/Research/Rohan_ensemble/training_outputs/IBD/IBD_HF_static_embeddings_cross_gen_tests \
            --batch_size 32 \
            --layers 5 \
            --epochs 50 \
            --attn_heads 5 \
            --cuda \
            --log_file /scratch/popeq/Research/Rohan_ensemble/training_outputs/logs/IBD_HF_static_embeddings_cross_gen_tests_log_${i}.txt \
            --freeze_opt 2 \
            --freeze_encoders 5 \
            --weighted_sampler \
            -s 513 \
...
run_sh(){
    for i in {10..10}
        ...
        CUDA_VISIBLE_DEVICES=2 python begin.py \
            ...
            --vocab_path ~/guille/vocab_embeddings.npy \
            --output_path /scratch/popeq/Research/Rohan_ensemble/training_outputs/IBD/IBD_SH_static_embeddings_cross_gen_tests \
            --batch_size 32 \
            --layers 5 \
            --epochs 50 \
            --attn_heads 5 \
            --cuda \
            --log_file /scratch/popeq/Research/Rohan_ensemble/training_outputs/logs/IBD_SH_static_embeddings_cross_gen_tests_log_${i}.txt \
            --freeze_opt 2 \
            --freeze_encoders 5 \
            --weighted_sampler \
            -s 513 \
