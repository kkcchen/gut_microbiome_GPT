...
import json
import os
from llm_microbiome_code.microbiome_transformers.finetune_discriminator.electra_discriminator import ElectraDiscriminator
from transformers import ElectraConfig
import torch.nn as nn


# electra_config = ElectraConfig(vocab_size=...,
#                                embedding_size=...,
#                                hidden_size=...,
#                                num_hidden_layers=...,
#                                num_attention_heads=...,
...
#                                num_labels=...)
# electra_disc = ElectraDiscriminator(electra_config)
# embed = np.load("/home/kevin/Desktop/gut_microbiome/llm_microbiome_code/microbiome_transformers/outputs/hmc_disc/_epoch15_disc_embed")
# vocab = np.load("/home/kevin/Desktop/gut_microbiome/dataset/hmc/electra/bac_vocab.npy")
vocab_size = 4680
embed = nn.Embedding.from_pretrained("/home/kevin/Desktop/gut_microbiome/llm_microbiome_code/microbiome_transformers/outputs/hmc_disc/_epoch15_disc_embed", freeze=True, padding_idx=vocab_size-1)
...
...
#     X_train, X_test, y_train, y_test = train_test_split(X, Y_binary, test_size=0.8, random_state=42)
#
#     # Initialize the RandomForestClassifier.
#     rf_model = RandomForestClassifier(n_estimators=100, random_state=69, verbose=1)
#
